...
class Interfaces(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = verbose_name   #因为这个模型类名interfaces是复数形式，所以要进行统一
